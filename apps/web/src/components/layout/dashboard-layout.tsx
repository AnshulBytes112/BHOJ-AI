...
import { CalendarDays, Clock, Bell, ChevronDown, Menu, X, LogOut } from 'lucide-react';
...
function StaticDateTime() {
  ...
  return (
    <div className="hidden sm:flex items-center gap-3 mr-2">
      <div className="flex items-center gap-2 text-[13px] font-semibold text-gray-600 bg-gray-50 px-3 py-1.5 rounded-md border border-gray-100 shadow-sm">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="relative">
                <div 
                  ...
                  className="flex items-center gap-2.5 cursor-pointer hover:bg-gray-50 rounded-lg px-2 py-1 transition-colors"
                >
